...
public class FilesController : Controller
{
    ...
    public FilesController(IFileSystem fileSystem, IPublishEndpoint publishEndpoint, PostedTransactionsFileSettings postedTransactionSettings, NonFinancialFileSettings nonFinancialFileSettings)
    {
